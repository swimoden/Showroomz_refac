...
import com.kuwait.showroomz.databinding.FragmentFavoriteBinding
...
import com.kuwait.showroomz.view.adapters.FavoriteAdapter
...
class FavoriteFragment : Fragment() {
    ...
    private val favoritesAdapter: FavoriteAdapter by lazy {
        FavoriteAdapter(mutableListOf(),viewModel)
    ...
    override fun onResume() {
        ...
        LogProgressRepository.logProgress("Favorites_list_screen")
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel = ViewModelProviders.of(this).get(FavoriteVM::class.java)
    ...
    private fun observeData() {
        ...
        viewModel.favorites.observe(viewLifecycleOwner, Observer {
            favoritesAdapter.refresh(it)
        })
        viewModel.loading.observe(viewLifecycleOwner, Observer { isloading ->
            binding.progressCircular.isVisible = isloading
            binding.favoriteRecycler.isVisible = !isloading
            if (isloading) {
        ...
        viewModel.empty.observe(viewLifecycleOwner, Observer {
            ...
            binding.favoriteRecycler.isVisible=!it
        })
