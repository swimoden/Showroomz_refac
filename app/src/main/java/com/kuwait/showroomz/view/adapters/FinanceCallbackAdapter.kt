...
import com.kuwait.showroomz.view.fragment.FinanceCallbackFragmentDirections

class FinanceCallbackAdapter(private var list: List<Callback>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            Navigation.findNavController(it).navigate(FinanceCallbackFragmentDirections.showFinanceCallbackItem(callback))
        }
