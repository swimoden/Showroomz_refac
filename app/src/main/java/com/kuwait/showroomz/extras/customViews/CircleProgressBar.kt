...
class CircleProgressBar @JvmOverloads constructor(
    ...
    private var primaryColor: Int= R.color.colorPrimary
    private  var secondColor: Int=R.color.colorYellow
    ...
    private val backgroundPaint = Paint().apply {
        ...
        color = ContextCompat.getColor(context,secondColor)
    ...
    private val progressPaint = Paint().apply {
        color =  ContextCompat.getColor(context,primaryColor)
        style = Paint.Style.STROKE
        strokeWidth = backgroundWidth
        isAntiAlias = true
    }
